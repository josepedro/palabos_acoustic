...
signal_in = textread('testando_um_dominio_menor/signal_in.dat');
...
pressures = textread('testando_um_dominio_menor/system_abom_measurement_data/history_pressures_system_abom_measurement_data.dat');
length_duct = 3*(6*a);
...
uiopen('panhuis_code/abs_r_015.fig',1)
hold on;
...
uiopen('panhuis_code/loa_015.fig',2)
hold on;
