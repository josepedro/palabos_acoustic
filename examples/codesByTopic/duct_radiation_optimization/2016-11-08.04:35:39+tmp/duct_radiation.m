...
close all;
% chirp
pressures = textread('3r_p2/history_pressures_3r_p2.dat');
...
particle_velocity = textread('3r_p2/history_velocities_z_3r_p2.dat');
particle_velocity = [particle_velocity(:)];
particle_velocity = particle_velocity(100:end);
%pressures = particle_velocity(1:length(particle_velocity));

window = hanning(length(particle_velocity));
particle_velocity = window.*particle_velocity;
