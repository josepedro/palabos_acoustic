...
pressures_1 = textread('minor_p1/history_pressures_minor_p1.dat');
pressures_1 = [pressures_1(:)];
pressures_2 = textread('minor_p2/history_pressures_minor_p2.dat');
...
radius = a;
diameter = 2*a;
length_duct = 10*diameter + 30;
const = 0;
L_1 = length_duct - 3*diameter - 30 + const - 1*radius;
L_2 = L_1 - 4*diameter + const + 1*radius;
cs = 1/sqrt(3);
